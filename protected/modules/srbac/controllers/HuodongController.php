...
class HuodongController extends Controller
{
	...
	public function init(){
		$this->filePath=array(
	      1=>'huodong/'.date('Y-m-d').'/',//套系(从upload目录开始)
		);
	}
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Huodong']))
		{
			$model->attributes=$_POST['Huodong'];
	...
	{
		$dataProvider=new CActiveDataProvider('Huodong');
	...
	{
		$model=new Huodong('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Huodong']))
			$model->attributes=$_GET['Huodong'];
	 ...
	 * @return Huodong the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Huodong::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Huodong $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='huodong-form')
		{
