 ...
 * 
 * @author Elmer Zhang <freeboy6716@gmail.com> and windsdeng@gmail.com http://www.dlf5.com edit
 */
...
class SaeTClientV2
{
    ...
    /**
     * 根据用户ID获取用户信息
     * 对应API：{@link https://api.weibo.com/2/users/show.json }
     * ＠param array $token
     * @return array
     * @author windsdeng@gmail.com http://www.dlf5.com add
     */
    function getUserShow($token)
    {
        return $this->oauth->get('users/show',$token);
    }
